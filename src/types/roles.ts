...
export type Permiso =
  | "ver_dashboard_global"  | "gestionar_clinicas"  | "configurar_consultorio"  | "ver_reportes_financieros" | "gestionar_pacientes"
  | "gestionar_agenda" | "gestionar_historia_clinica"  | "gestionar_cobros";
// 3. Mapeamos qué permisos tiene cada rol
export const PERMISOS_POR_ROL: Record<RolUsuario, Permiso[]> = {
  SUPER_ADMIN: ["ver_dashboard_global", "gestionar_clinicas"],
  TENANT_ADMIN: [    "configurar_consultorio",    "ver_reportes_financieros",    "gestionar_pacientes",    "gestionar_agenda",
    "gestionar_cobros",],
  ESPECIALISTA: [    "gestionar_agenda",    "gestionar_pacientes",    "gestionar_historia_clinica", ],
  SECRETARIA: ["gestionar_agenda", "gestionar_pacientes", "gestionar_cobros"],
};
