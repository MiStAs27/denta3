                  ...
                  {citasMostradas.map((cita) => {
                    ...
                    return (
                      <div 
                        ...
                        className={`w-full block truncate whitespace-nowrap text-[11px] px-1.5 py-0.5 rounded-md font-medium border cursor-pointer transition-transform hover:scale-[1.01] ${estiloClases}`}
